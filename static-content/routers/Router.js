...
export function Router() {
    ...
    router.handle = function (state, props) {
        ...
        if (handlerData == null) {
            ...
            throw new console.log(`No handler for path ${state.currentPath}`);
        }
    ...
    router.addRouteHandler = function (path, handler) {
        if (typeof path !== 'string')
            throw new console.log(`Path must be a string`);

        if (typeof handler !== 'function')
            throw new console.log(`Handler for path ${path} is not a function`);
     ...
     */
    router.addDefaultNotFoundRouteHandler = function (handler) {
