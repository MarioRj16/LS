...
/*
    ...
    searchParams.set('game', gameInput);

    if(dateInput!=null)searchParams.set('date', dateInput);
    if(stateInput!=null)searchParams.set('state', stateInput);
    if(playerIdInput!=null)searchParams.set('playerId', playerIdInput);
